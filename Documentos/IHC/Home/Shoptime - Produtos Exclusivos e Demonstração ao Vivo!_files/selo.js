(function(root) {
	...
	// Mapa com as informa̵̤es de todas as marcas
	var brand_map = {
		'americanas': {
			ref: 'ACOM',
			selo: {
		...
		'shoptime': {
			ref: 'SHOP',
			selo: {
				selector: 'a.url, .mp-picture, div.image_carousel ul li a, .wrapper-productstv .lt-pd-prod-url,  div.wPhoto a, .ewBox .prodBox .col01'
			}
		},
		'soubarato': {
			ref: 'SB',
	...
	// Adiciona refer̻ncias gen̩ricas ao mapa de marcas
	...
	// Manipula callback de pagina̤̣o de dep, linha e sublinha pra rodar novamente.
